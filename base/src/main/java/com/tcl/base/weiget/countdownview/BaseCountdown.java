...
class BaseCountdown {
    ...
    public boolean isConvertDaysToHours = true;
    ...
    public void initStyleAttr(Context context, TypedArray ta) {
        ...
        if (ta.getBoolean(R.styleable.CountdownView_isHideTimeBackground, true)) {
            isConvertDaysToHours = ta.getBoolean(R.styleable.CountdownView_isConvertDaysToHours, true);
        }
...
//        if (!isShowMinute && !isShowSecond) isShowSecond = true;
    ...
    private float getDayAndHourContentWidth() {
        ...
        if (isShowHour) {
            ...
            mHourTimeTextWidth = tempRect.width() + ConvertUtils.dp2px(12);
