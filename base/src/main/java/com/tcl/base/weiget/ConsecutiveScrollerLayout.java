...
import com.tcl.base.utils.LayoutParamsUtils;
import com.tcl.base.utils.ScrollUtils;
...
public class ConsecutiveScrollerLayout extends ViewGroup implements ScrollingView, NestedScrollingParent2, NestedScrollingChild2 {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        if (params instanceof LayoutParams) {
            LayoutParamsUtils.INSTANCE.invalidTopAndBottomMargin((LayoutParams) params);
        }
    ...
    protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        LayoutParamsUtils.INSTANCE.invalidTopAndBottomMargin((LayoutParams) child.getLayoutParams());
    ...
    public int getDrawingPosition(View child) {
